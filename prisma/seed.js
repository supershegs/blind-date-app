...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var demoUser, _a, _b, demoAdmin, _c, _d;
        var _e, _f, _g, _h;
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    return [4 /*yield*/, bcrypt.hash('demouser123', 10)];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, bcrypt.hash('demoadmin123', 10)];
                ...
                case 4:
                    demoAdmin = _j.sent();
                    console.log({ demoUser: demoUser, demoAdmin: demoAdmin });
                    return [2 /*return*/];
            }
        });
    });
